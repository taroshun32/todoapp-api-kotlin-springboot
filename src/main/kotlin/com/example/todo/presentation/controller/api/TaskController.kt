...
class TaskController : TaskApiBaseController() {
  ...
  override fun apiV1TasksTaskIdDelete(authorization: String, xminusOSMinusTYPE: String, xminusAPPMinusVERSION: String, taskId: String) {
    TODO("Not yet implemented")
  }

  override fun apiV1TasksTaskIdDonePut(authorization: String, xminusOSMinusTYPE: String, xminusAPPMinusVERSION: String, taskId: String, taskDonePutParameter: TaskDonePutParameter?) {
    TODO("Not yet implemented")
  }
